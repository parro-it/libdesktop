...
#define LIBUI_FUNCTION(FN_NAME) napi_value FN_NAME(napi_env env, napi_callback_info info)
...
static size_t env_var_size = UNINITIALIZED;
#endif


static inline napi_value make_bool(napi_env env, bool value) {
	napi_value value_js;
...
static inline napi_value make_double(napi_env env, double value) {
	napi_value value_js;
...
static inline napi_value make_int32(napi_env env, int value) {
	napi_value value_js;
...
static inline napi_value make_int64(napi_env env, long value) {
	napi_value value_js;
...
static inline napi_value make_uint32(napi_env env, unsigned int value) {
	napi_value value_js;
...
static inline napi_value make_utf8_string(napi_env env, const char *char_ptr) {
	napi_value result;
